...
<form action="{{ route('proveedores.store') }}" method="POST">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-8">
                    ...
                    <input type="text" name="razon_social" value="{{ old('razon_social') }}" class="form-control @error('razon_social') is-invalid @enderror" required>
                    @error('razon_social')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-4">
                    <label class="form-label">RUC</label>
                    <input type="text" name="ruc" value="{{ old('ruc') }}" class="form-control @error('ruc') is-invalid @enderror" maxlength="11">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="rubro" value="{{ old('rubro') }}" class="form-control" placeholder="Ej: Materiales de construcción">
                </div>
                <div class="col-12">
    ...
    <div class="action-bar">
        ...
        <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg"></i>Registrar Proveedor</button>
    </div>
</form>
</div>
@endsection
