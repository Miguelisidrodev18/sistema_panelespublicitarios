...
@section('subtitle', 'Registrar nuevo trámite administrativo')
...
<div class="page-header">
    <div class="page-header-left">
        ...
        <div>
            ...
            <div style="font-size:13px;color:var(--text-light);margin-top:2px">Completa los datos del trámite y los pasos del proceso</div>
        </div>
    </div>
</div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <select name="estado" class="form-control">
                    ...
                    <option value="{{ $val }}" {{ old('estado', 'en_tramite') === $val ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="entidad_nombre" value="{{ old('entidad_nombre') }}"
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="codigo_tramite" value="{{ old('codigo_tramite') }}"
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="encargado" value="{{ old('encargado') }}"
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="encargado_area" value="{{ old('encargado_area') }}"
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="doc_presentado" value="{{ old('doc_presentado') }}"
...
<div class="card" style="margin-bottom:20px">
    <div class="card-header" style="border-left-color:#7C3AED">
        ...
        <span class="badge badge-gray" id="contador-pasos">0 paso(s)</span>
    </div>
...
<div style="display:flex;gap:10px;justify-content:flex-end;margin-bottom:32px">
    ...
    <button type="submit" class="btn btn-primary"><i class="bi bi-floppy"></i>Guardar trámite</button>
</div>
...
document.getElementById('btn-add-paso').addEventListener('click', () => {
    document.getElementById('pasos-container').appendChild(crearFilaPaso());
    actualizarContador();
});
</script>
@endpush
